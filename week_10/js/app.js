...
function init() {
	...
	var material = new THREE.LineBasicMaterial( { color: 0x000000, opacity: 0.2, visible : false } );
	...
	// geom.vertices.push ( new THREE.Vector3( 900, 0, 0 ) )
	// geom.vertices.push ( new THREE.Vector3( 0, 0, 0 ) )

	// geom.vertices.push ( new THREE.Vector3( 0, 200, 0 ) )
	// geom.vertices.push ( new THREE.Vector3( 0, 0, 0 ) )
	...
	// 	oline = new THREE.Line( geom, mat )

	// oline.type = THREE.LinePieces;
	// scene.add( oline );
	//
	...
	plane = new THREE.Mesh( new THREE.PlaneGeometry( 2000, 2000 ), new THREE.MeshBasicMaterial( { wireframe: true } ));
...
function onDocumentMouseMove( event ) {
	...
	if ( intersects.length > 0 ) {
		...
		ROLLOVERED = intersects[ 0 ].object //.material.opacity = .4;
		console.log( ROLLOVERED)
		// ROLLOVERED.color.setHex( 0xff0000 )
		// ROLLOVERED.vertexColors = new THREE.Color( 0xff0000 )
